...
webdriver = webdriver.Chrome(
    executable_path="C:\\Users\\rahul negi\\Downloads\\whatsappBomber-master\\chromedriver.exe")  # use the path wehere you have installed your chromedriver
sleep(2)
...
webdriver.get(name)
sleep(3)
hash = webdriver.find_element_by_css_selector(
    '#react-root > section > main > div > header > section > ul > li:nth-child(3) > a > span').text
y = hash.replace(',', '')
...
while (flag >= 0):
    ...
    try :
        ...
        xpath1 = "/html/body/div[4]/div/div/div[2]/ul/div/li["
        xpath1 += str(i)
        xpath1 += "]/div/div[2]/div[1]/div/div/a"
    except NoSuchElementException:
        # FIRST SUBJECT PROFILE :-
        xpath1 = "/html/body/div[3]/div/div/div[2]/ul/div/li["
        xpath1 += str(i)
        xpath1 += "]/div/div[2]/div[1]/div/div/a"
    ...
    its_list = webdriver.find_element_by_css_selector(
        '#react-root > section > main > div > header > section > ul > li:nth-child(3) > a')
    its_list.click()
    sleep(2)

    n = webdriver.find_element_by_css_selector(
        '#react-root > section > main > div > header > section > ul > li:nth-child(3) > a > span').text  # following of subject in int
    m = n.replace(',', '')
    print(m)
    l = int(m)
    ...
    if l <= 10:
        ...
        for x in range(1, int(m)):
            ...
            xpath2 = "/html/body/div[4]/div/div/div[2]/ul/div/li["
            xpath2 += str(x)
